...
mod benchmarks {
	...
	#[benchmark]
	fn bare_dispatch(n: Linear<1, 1024>) {
		...
		let len = n.saturating_div(16) as usize;
		let data_to_encode = vec![codec::Compact::<u128>(0x111111111111); len];

		#[block]
		{
			let _ = codec::Encode::encode(&data_to_encode);
